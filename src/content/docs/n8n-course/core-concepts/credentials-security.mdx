...
App တစ်ခုကို Search လုပ်ပြီး (ဥပမာ "Gmail") Credential Type ကို ရွေးပါ — Gmail (OAuth2) သို့မဟုတ် Gmail (IMAP)။
...
App အများစုအတွက် n8n မှ **Built-in OAuth** ပေးသည်။ "Connect my account" ကို နှိပ်ရုံသာ လုပ်ရသည် — API Key ထည့်ရန် မလိုပါ။
</Aside>
