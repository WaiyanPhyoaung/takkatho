...
Table တွေကို မချိတ်ဆက်မီ သူတို့ကြားက relationship ကိုအရင်နားလည်ရပါမယ်။ ဒီ relationship ကို [Primary Key](/relational-database/terminology/structure-related-terms/primary-key/) နဲ့ [Foreign Key](/relational-database/terminology/structure-related-terms/foreign-key/) တွေက သတ်မှတ်ပေးပါတယ်။
...
FULL OUTER JOIN က LEFT JOIN နဲ့ RIGHT JOIN ရဲ့ ရလဒ်နှစ်ခုကို ပေါင်းထားတာနဲ့ အတူတူပါပဲ။
...
```
ဥပမာ - ဝန်ထမ်းတိုင်းနဲ့ ဌာနတိုင်းကို စာရင်းပြုစုပြီး ချိတ်ဆက်လို့ရတာတွေကို တွဲပြပါ။
...
> မှတ်ချက် - MySQL database က FULL OUTER JOIN ကို support မလုပ်ပါဘူး။ ဒါပေမဲ့ LEFT JOIN နဲ့ RIGHT JOIN ကို UNION clause သုံးပြီး ပေါင်းစပ်ခြင်းဖြင့် အလားတူရလဒ်မျိုး ရအောင်လုပ်နိုင်ပါတယ်။
