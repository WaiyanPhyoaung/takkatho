...
-- database system က transaction တစ်ခုလုံးကို အလိုအလျောက် ROLLBACK လုပ်ပြီး
...
Index ဆိုတာက database search engine က data တွေကို လျင်မြန်စွာရှာဖွေနိုင်ရန် အထူးလုပ်ထားတဲ့ lookup table တစ်ခုဖြစ်ပါတယ်။ 
...
- Index တည်ဆောက်ခြင်း - သင် index လုပ်လိုက်တဲ့ column (ဥပမာ- Department) ရဲ့တန်ဖိုးတွေကို ကူးယူပြီး စီစဉ်တကျ (sorted) စာရင်းတစ်ခု လုပ်ပါတယ်။
...
data ပြောင်းလဲမှုတိုင်းမှာ index ကိုယ်တိုင်ကိုလည်း update လုပ်ရန် လိုအပ်တာကြောင့်ဖြစ်ပါတယ်။

#### ဘယ်အချိန်မှာသုံးမလဲ 
WHERE clause တွေထဲမှာ မကြာခဏအသုံးပြုတဲ့ column တွေမှာ သုံးသင့်ပါတယ်။ Primary key တွေကိုတော့ database က အလိုအလျောက် index လုပ်ပြီးသားဖြစ်ပါတယ်။
...
View ကိုယ်တိုင်က data မသိမ်းထားပေမယ့် မူရင်း data တွေကို ရိုးရှင်းပြီး လုံခြုံတဲ့ပုံစံဖြင့် ကြည့်ရှုနိုင်ရန် လုပ်ပေးပါတယ်။ 

#### အကျိုးကျေးဇူးများ - 

- ရိုးရှင်းမှု (Simplicity) - ရှုပ်ထွေးတဲ့ JOIN တွေနှင့် တွက်ချက်မှုတွေကို end-users တွေမမြင်ရအောင် လုပ်ပေးနိုင်ပါတယ်။
