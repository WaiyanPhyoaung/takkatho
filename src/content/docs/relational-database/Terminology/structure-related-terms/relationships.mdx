...
ဥပမာကိုကြည့်မယ်ဆိုရင် `Books table` နဲ့ `Authors table` ကြားမှာ `BookAuthors table` (linking table) ကို သုံးထားပါတယ်။ စာအုပ်တစ်အုပ်တည်းကို စာရေးဆရာအများကြီးက ပေါင်းရေးနိုင်သလို စာရေးဆရာတစ်ယောက်တည်းကလည်း စာအုပ်တွေအများကြီးရေးသားနိုင်ပါတယ်။
...
လူတစ်ယောက်က သူငယ်ချင်းတွေအများကြီးရှိနိုင်ပြီး၊ သူငယ်ချင်းတစ်ယောက်ချင်းစီကလည်း သူ့ကို ပြန်လည်သူငယ်ချင်းဖွဲ့ထားတာမျိုး (ဥပမာ- Facebook Friend System) ကို `PersonFriend` ဆိုတဲ့ Linking Table နဲ့ တည်ဆောက်နိုင်ပါတယ်။
...
Child Table မှာတော့ Parent Table ရဲ့ အချက်အလက်တွေနဲ့ ပတ်သက်တဲ့ ပိုပြီး "အသေးစိတ်ကျတဲ့" အချက်အလက်တွေ ပါဝင်လေ့ရှိပါတယ်။ (ဥပမာ- Orders, Employees)။ 
