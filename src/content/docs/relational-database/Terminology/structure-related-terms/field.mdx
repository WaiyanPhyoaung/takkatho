...
**✅ Good design:** ဖုန်းနံပါတ်တစ်ခုစီအတွက် သီးခြား records  တွေ ဒါမှမဟုတ် သီးခြား field တွေ ခွဲပြီး သိမ်းဆည်းခြင်း။ (ဥပမာ- PhoneNumber1, PhoneNumber2 သို့မဟုတ် ဖုန်းနံပါတ်တွေအတွက် သီးခြား table တစ်ခု (PhoneNumbers table) ထားရှိခြင်း)။
