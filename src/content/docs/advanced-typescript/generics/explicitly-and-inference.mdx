...
ဒီလိုမျိုး Generic ရေးထားတဲ့ Function ကို ဘယ်လို ခေါ်သုံးရမလဲ? နည်းလမ်း နှစ်ခု ရှိပါတယ် ခင်ဗျာ။

## နည်းလမ်း ၁: Type ကို ကိုယ်တိုင် တိုက်ရိုက် ပြောပြခြင်း

Function ကို ခေါ်သုံးတဲ့အခါ Angle Bracket `< >` ထဲမှာ `T` နေရာအတွက် ဘယ် Type ဖြစ်ရမယ်ဆိုတာကို ကျွန်တော်တို့ ကိုယ်တိုင် တိုက်ရိုက် ထည့်ပြောပေးလို့ ရပါတယ်။

<Code code={code} lang="typescript" title="index.ts" />

## နည်းလမ်း ၂: Type Inference (TypeScript က သူ့ဘာသာ သိခြင်း)

အချိန်အများစုမှာတော့ TypeScript က ကျွန်တော်တို့ ထည့်လိုက်တဲ့ Data ရဲ့ တန်ဖိုးကို ကြည့်ပြီး `T` နေရာမှာ ဘယ် Type ဖြစ်သင့်သလဲ ဆိုတာကို သူ့ဘာသာသူ ခန့်မှန်းပြီး သိနိုင်ပါတယ်။ ဒီလိုမျိုး TypeScript က ကိုယ်တိုင် ခန့်မှန်းသိတာကို **Inference** လို့ ခေါ်ပါတယ်။ ဒီနည်းလမ်းက Code ရေးရတာ ပိုမြန်ပြီး ပိုလွယ်ကူစေပါတယ်။

<Code code={code2} lang="typescript" title="index.ts" />

<Aside title="မှတ်ချက်" >
  အများအားဖြင့်တော့ Inference ကိုပဲ သုံးကြပါလိမ့်မယ်။ ဒါပေမဲ့ တိုက်ရိုက်
  ပြောပြလို့ရတယ်ဆိုတာကို သိထားတာက ပိုရှုပ်ထွေးတဲ့ အခြေအနေတွေကြုံလာရင် အရမ်း အရေးကြီးပါတယ်။ အဓိက
  မှတ်ထားရမှာက Type Safety (Type မှန်ကန်စိတ်ချရမှု) ပါပဲ။ Generic Function ထဲကို
  ဘယ် Type ထည့်လိုက်သည်ဖြစ်စေ၊ TypeScript က အဲဒီ Function ကနေ ပြန်ထွက်လာမယ့်
  Data ကလည်း အဲဒီ Type အတိုင်းပဲ ဖြစ်လိမ့်မယ်လို့ သေချာ သိနေပါတယ်။ ဒါကြောင့် Code တွေ
  ပိုပြီး စိတ်ချရလာတာပေါ့ ခင်ဗျာ။
</Aside>
