...
ကျွန်တော်တို့ Code ရေးတဲ့အခါ အပြင်က API (Application Programming Interface) တွေကနေ Data တွေ သွားယူရတာကို အမြဲလိုလို လုပ်ရပါတယ်။ ဒီ Data ယူတဲ့ Logic (အလုပ်လုပ်ပုံ) ကို Generic ဖြစ်အောင် ရေးထားတာက အရမ်း အသုံးဝင်ပြီး လုပ်ရိုးလုပ်စဉ်လိုတောင် ဖြစ်နေပါပြီ။

အရင် သင်ခန်းစာမှာ ကျွန်တော်တို့ `ApiResponse` ဆိုတဲ့ Generic Interface လေးတစ်ခု သတ်မှတ်ခဲ့တာ မှတ်မိဦးမယ် ထင်ပါတယ် ခင်ဗျာ။ API ကနေ ဘယ်လို Data အမျိုးအစား ပြန်လာလာ၊ ဒီ `ApiResponse` ပုံစံအတိုင်း ထည့်သုံးလို့ ရတာပေါ့။

<Code code={dataFetching} lang="typescript" title="index.ts" />

<br />
<Aside title="ရှင်းပြချက်">
  {`ဒီ Function ကို ကြည့်ရင် ResponseType ဆိုတဲ့ Generic Type နဲ့ ရေးထားတာ တွေ့ရပါမယ်။ ဒီ Function ကို ခေါ်တဲ့အခါ (ဥပမာ fetchData<User>('/api/users/123') လိုမျိုး) ResponseType နေရာမှာ ဘယ် Type (ဥပမာ User) ဖြစ်ရမယ်ဆိုတာ ကျွန်တော်တို့ သတ်မှတ်ပေးလိုက်တယ်။ ဒါကြောင့် API ကနေ ပြန်လာမယ့် ApiResponse ထဲက data Field ဟာ ကျွန်တော်တို့ သတ်မှတ်လိုက်တဲ့ User Type ဖြစ်ရမယ်လို့ TypeScript က သိသွားပါပြီ။ ဒီလိုရေးတာက API Call တွေကို Type မှန်ကန်စိတ်ချရစေပြီး Data ယူတဲ့ Logic ကိုလည်း ပြန်လည် အသုံးပြုလို့ရအောင် လုပ်ပေးပါတယ်။ Axios လိုမျိုး Data ယူတဲ့ Libraries တွေမှာလည်း ဒီလို Generic နည်းလမ်းတွေ သုံးထားတာ တွေ့ရပါလိမ့်မယ် ခင်ဗျာ။`}
</Aside>

### UI Components များ (ဥပမာ - React)

Website ဒါမှမဟုတ် Application တွေအတွက် UI (User Interface) Components တွေ ရေးတဲ့အခါ (ဥပမာ - Lists တွေ၊ Tables တွေ၊ Dropdowns တွေ) Data အမျိုးမျိုးကို ပြသနိုင်တဲ့ Components တွေ လိုလာတတ်ပါတယ်။ ဒီလို Components တွေကို Generic သုံးပြီး ရေးတာက တကယ် အသုံးဝင်ပါတယ်။

React Framework ကို ဥပမာယူပြီး ရေးထားတဲ့ Code လေး ကြည့်ရအောင် (ဒါက Concept ကို ပြချင်တာပါ၊ React Syntax ကို အသေးစိတ် နားမလည်ရင်လည်း ကိစ္စမရှိပါဘူး ခင်ဗျာ)။ Dropdown List (`Select` Box) Component လေးတစ်ခု ရေးကြည့်ပါမယ်။

<Code code={react} lang="typescript" title="index.ts" />

<Aside title="ရှင်းပြချက်" type="note">
  {`ဒီ Select Component ဟာ ValueType ဆိုတဲ့ Generic Type တစ်ခုပေါ်မှာ မူတည်ပြီး အလုပ်လုပ်ပါတယ်။ သူက Options တွေမှာ ပါတဲ့ တကယ့် တန်ဖိုး (Value) က string Type ဖြစ်နေစေ၊ number Type ဖြစ်နေစေ (ဒါမှမဟုတ် extends string | number လို့ ကန့်သတ်ထားတဲ့ တခြား ရိုးရှင်းတဲ့ Type တွေ) လက်ခံပြီး အလုပ်လုပ်နိုင်ပါတယ်။ Option ပြောင်းတဲ့အခါ ခေါ်မယ့် onChange Function ကလည်း မှန်ကန်တဲ့ ValueType အတိုင်း Data ကို ပြန်ပို့ပေးပါတယ်။ ဒါကြောင့် ThemeSelect, RatingSelect စသဖြင့် Type တစ်ခုချင်းစီအတွက် Components တွေ ခွဲရေးနေစရာ မလိုတော့ပါဘူး။ Select Component တစ်ခုတည်းနဲ့တင် Data အမျိုးမျိုးအတွက် ပြန်သုံးလို့ရသွားပြီ ဖြစ်ပါတယ် ခင်ဗျာ။`}
</Aside>
