...
Generic တွေမှာ `T` က ဘာ Type မဆို ဖြစ်လို့ရတယ်ဆိုတဲ့အတွက် တကယ် အစွမ်းထက်ပါတယ်။ ဒါပေမဲ့ တစ်ခါတလေကျတော့ အဲဒီ လိုက်လျောလွန်းတာကြီးကပဲ ပြဿနာ ပြန်ဖြစ်တတ်တယ်။ ဥပမာ - ကျွန်တော်တို့ရဲ့ Generic Function ထဲမှာ Argument (လက်ခံရရှိတဲ့ Data) ရဲ့ Property တစ်ခုခုကို သုံးချင်တယ်ဆိုပါစို့။
...
<br />
{`ဒီမှာ TypeScript က မှန်မှန်ကန်ကန်ပဲ Error ပြပါတယ်။ ဘာလို့လဲဆိုတော့ T က ဘယ် Type မဆို ဖြစ်နိုင်လို့ပါပဲ။ တကယ်လို့ တစ်ယောက်ယောက်က logLength(123) လို့ ခေါ်လိုက်ရင် ဘာဖြစ်မလဲ? number Type တွေမှာ .length ဆိုတဲ့ Property မှ မရှိတာ။ ဒါမှမဟုတ် logLength({ name: 'Bob' }) လို့ ခေါ်ရင်ရော? အဲဒီ Object မှာလည်း .length ဆိုတာ မရှိပါဘူး။ ဒီလိုမျိုး T က တကယ့်ကို ဘာမဆို ဖြစ်နိုင်နေရင် ကျွန်တော်တို့ရဲ့ Function က Type Safety မဖြစ်တော့ပါဘူး (စိတ်မချရတော့ပါဘူး)။`}

### ဖြေရှင်းနည်း: extends ကို အသုံးပြု၍ ကန့်သတ်ခြင်း (Constraints)

ဒီတော့ ကျွန်တော်တို့ TypeScript ကို ပြောပြဖို့ လိုလာပါပြီ။ "အိုကေ၊ `T` က Flexible ဖြစ်ပါစေ၊ ဒါပေမဲ့ သူဟာ `length` ဆိုတဲ့ Property တစ်ခု ပါကို ပါရမယ် (ပြီးတော့ အဲဒီ Property က ဖြစ်နိုင်ရင် `number` Type ဖြစ်သင့်တယ်)" လို့ သတ်မှတ်ပေးရပါမယ်။
...
<Aside title="ရှင်းပြချက်">
  {`<T extends Lengthwise> ဆိုတာကို ဖတ်ရရင် "T က ဘယ် Type မဆို ဖြစ်လို့ရတယ်၊ ဒါပေမဲ့ သူဟာ Lengthwise Interface ကို extends လုပ်ထားရမယ် (ဒါမှမဟုတ် Lengthwise Interface နဲ့ ပုံစံ (Shape) တူရမယ်၊ Lengthwise မှာပါတဲ့ Property တွေ ပါရမယ်)" လို့ ပြောလိုက်တာပါပဲ ခင်ဗျာ။ ဒါကြောင့် T Type ဟာ length ဆိုတဲ့ number Type Property တစ်ခု သေချာပေါက် ပါဝင်ရမယ်လို့ အာမခံလိုက်တာပါပဲ။`}
</Aside>

### ကန့်သတ်ထားသော Generic များကို အသုံးပြုခြင်း

ဒီလို ကန့်သတ်ချက် ထည့်လိုက်တော့ ကျွန်တော်တို့ရဲ့ Function က ကန့်သတ်ချက်နဲ့ ကိုက်ညီတဲ့ Type တွေနဲ့ စိတ်ချစွာ အလုပ်လုပ်နိုင်သွားပါပြီ။

<Code code={extendsCode2} lang="typescript" title="index.ts" />

<Aside title="ကောင်းကျိုး" type="tip">
  Constraints တွေက ကျွန်တော်တို့ကို အကောင်းဆုံး နှစ်မျိုးလုံး ပေးစွမ်းနိုင်ပါတယ်။ Generic ရဲ့ Flexible ဖြစ်မှုရယ်၊ လိုချင်တဲ့ Property ဒါမှမဟုတ် Method တွေ ရှိကြောင်း သိရတဲ့ Type Safety ရယ်ပေါ့ ခင်ဗျာ။
</Aside>

တစ်ခါတလေကျတော့ သီးခြား Interface တစ်ခု သတ်မှတ်ဖို့တောင် မလိုပါဘူး။ တခြား Type တစ်ခုရဲ့ ပုံစံ (Shape) အတိုင်း တိုက်ရိုက် ကန့်သတ်လို့ ရပါတယ်။ `keyof T` လိုမျိုး Keyword တွေကို သုံးတာပေါ့။ `keyof T` ဆိုတာက `T` Type မှာရှိတဲ့ Property တွေရဲ့ နာမည်တွေကို ပြောတာပါ။

<Code code={extendsCode3} lang="typescript" title="index.ts" />

<br />
<Aside title="ရှင်းပြချက်" type="note">
  {`getProperty<T extends object, K extends keyof T> Function မှာ Generic Type နှစ်ခု (T နဲ့ K) သုံးထားပါတယ်။ T extends object ဆိုတာ T က Object Type တစ်ခုခု ဖြစ်ရမယ်လို့ ကန့်သတ်တာပါ။ K extends keyof T ဆိုတာက K ဟာ T မှာ ရှိတဲ့ Property တွေရဲ့ နာမည်(Key) တွေထဲက တစ်ခု ဖြစ်ရမယ်လို့ ကန့်သတ်တာ ဖြစ်ပါတယ်။`}
</Aside>

ဒီလို သတ်မှတ်လိုက်တော့ `getProperty` Function ကို ခေါ်တဲ့အခါ `obj` ဆိုတဲ့ Object ရယ်၊ အဲဒီ Object ထဲမှာ တကယ်ရှိတဲ့ Property ရဲ့ နာမည် (Key) ရယ် ပဲ လက်ခံပါတယ်။ မရှိတဲ့ Property နာမည်ကို ထည့်ခေါ်ရင် Code ရေးနေတုန်းမှာတင် TypeScript က Error ပြပေးပါတယ်။ ပြန်ထွက်လာမယ့် Data ရဲ့ Type ကလည်း `T[K]` (`T` ထဲက `K` ဆိုတဲ့ Property ရဲ့ Type) လို့ တိတိကျကျ သိရပါတယ် ခင်ဗျာ။
