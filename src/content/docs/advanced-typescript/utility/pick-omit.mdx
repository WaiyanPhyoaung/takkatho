...
<Aside title='ရည်ရွယ်ချက်' type="tip">
  `Pick<T, K>` နဲ့ `Omit<T, K>` Utility Types တွေကို သုံးပြီး ရှိပြီးသား Type ကနေ လိုချင်တဲ့ Properties တွေကို ရွေးထုတ်တာ ဒါမှမဟုတ် မလိုချင်တာတွေကို ဖယ်ထုတ်တာမျိုး လုပ်ပြီး Type အသစ်တွေ ဖန်တီးတတ်ဖို့ ဖြစ်ပါတယ်။ `K` ကတော့ `T` ထဲက Property နာမည်တွေရဲ့ ပေါင်းစပ်မှု ဖြစ်ပါတယ်။
</Aside>
...
- **ဘာလုပ်ပေးသလဲ**: `Pick<T, K>` က `T` Type မှာရှိတဲ့ Properties တွေထဲက `K` Type မှာ ရွေးထားတဲ့ Properties တွေကိုသာ ရွေးထုတ်ပြီး Type အသစ်တစ်ခု လုပ်ပေးပါတယ်။
...
- **ဘယ်လိုနေရာမှာ သုံးသလဲ**: Data Transfer Object (DTO) တွေ လုပ်တဲ့အခါ ဒါမှမဟုတ် UI Component တွေအတွက် Data တချို့တဝက်ပဲ လိုတဲ့အခါမျိုးမှာ အသုံးဝင်ပါတယ်။ ဥပမာ User Preview Card လိုမျိုးပေါ့။

<Code lang="typescript" code={usage} title="index.ts" />

## `Omit<T, K>`: Properties တွေကို ချန်လှပ်ခြင်း

- **ဘာလုပ်ပေးသလဲ**: `Omit<T, K>` က `T` Type ထဲက ကိုယ်မလိုချင်တဲ့ Properties တွေ `K` ကို ဖယ်ထုတ်ပြီး ကျန်တာတွေနဲ့ Type အသစ်တစ်ခု လုပ်ပေးပါတယ်။
- **ဘယ်လို သုံးမလဲ**: `Omit<UserProfile, "lastLogin" | "isActive">`
- **ရလာမယ့် Type (ပုံစံ)**:

<Code lang="typescript" code={omit} title="index.ts" />

- **ဘယ်လိုနေရာမှာ သုံးသလဲ**: လျှို့ဝှက်အချက်အလက်တွေ ဒါမှမဟုတ် သီးခြားအခြေအနေတစ်ခုနဲ့ မဆိုင်တဲ့ Properties တွေကို ချန်လှပ်ပြီး Type အသစ် ဖန်တီးတဲ့နေရာမှာ အသုံးဝင်ပါတယ်။ ဥပမာ လူသိရှင်ကြား ပြသရမယ့် User စာရင်းအတွက် Type မျိုးပေါ့။
