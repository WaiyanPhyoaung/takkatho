...
- **ဘာလုပ်ပေးသလဲ**: `Readonly<T>` က `T` Type မှာရှိတဲ့ Properties အားလုံးကို `readonly` (ဖတ်လို့ပဲရမယ်၊ တန်ဖိုး အသစ် ပြန်ထည့်လို့ မရဘူး) ဖြစ်သွားအောင် Type အသစ်တစ်ခု လုပ်ပေးပါတယ်။
- **ဘယ်လို သုံးမလဲ**: `Readonly<UserProfile>`
- **ရလာမယ့် Type (ပုံစံ)**:

<Code lang="typescript" code={readonly} title="index.ts" />

- **ဘယ်လိုနေရာမှာ သုံးသလဲ**: Program စတဲ့အချိန်မှာပဲ Data တစ်ခါ သတ်မှတ်ပြီးရင် နောက်ထပ် ဘယ်တော့မှ တန်ဖိုး ပြောင်းလဲလို့ မရအောင် လုပ်ချင်တဲ့ Configuration Object မျိုးတွေ၊ ဒါမှမဟုတ် ပြင်ဆင်ခွင့်မရှိတဲ့ Data မျိုးတွေအတွက် အကောင်းဆုံးပါပဲ။
