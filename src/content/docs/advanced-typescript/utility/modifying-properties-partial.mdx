...
- **ဘာလုပ်ပေးသလဲ**: `Partial<T>` က `T` Type မှာရှိတဲ့ Properties အားလုံးကို Optional (ပါချင်မှပါ/ထည့်ချင်မှ ထည့်) ဖြစ်သွားအောင် Type အသစ်တစ်ခု လုပ်ပေးပါတယ်။
- **ဘယ်လို သုံးမလဲ**: `Partial<UserProfile>`
- **ရလာမယ့် Type (ပုံစံ)**:

<Code lang="typescript" code={partial} title="index.ts" />

- **ဘယ်လိုနေရာမှာ သုံးသလဲ**: User ရဲ့ အချက်အလက်ကို ပြင်ဆင်တဲ့ Function မျိုးတွေအတွက် အသုံးဝင်ပါတယ်။ ပြင်ချင်တဲ့ Field (အချက်အလက်) ကိုပဲ ပို့လိုက်လို့ ရပါတယ်။
