...
<Aside title="ရည်ရွယ်ချက်" type="tip">
  `satisfies` က ဘယ်ပြဿနာကို ဖြေရှင်းပေးသလဲဆိုတာ ရိုးရှင်းစွာ နားလည်ဖို့၊ သူ့ရဲ့
...
<Aside title="ရည်ရွယ်ချက်" type="tip">
  ...
  ဘာလို့ ပျောက်သွားသလဲ၊ ပြီးတော့ အဲဒီအချက်အလက်တွေကို ပြန်သုံးဖို့ ဘာလို့
  ခက်သွားသလဲဆိုတာ နားလည်ဖို့ ဖြစ်ပါတယ်။
</Aside>

### Typed object တစ်ခု သတ်မှတ်ခြင်း

ကျွန်တော်တို့ App တွေမှာ Objects တွေ အများကြီး ဖန်တီးရလေ့ ရှိပါတယ်။ အဲဒီ Objects တွေက သတ်မှတ်ထားတဲ့ General Structure နဲ့ ကိုက်ညီဖို့ လိုအပ်ပါတယ်။ ဥပမာ - Application အတွက် Configuration Object လိုမျိုးပေါ့ ခင်ဗျာ။
...
<Aside title="ရှင်းပြချက်">
  ...
  `featureFlags` ထဲမှာ `darkMode` တို့ ပါတယ်ဆိုတာကို အတိအကျ သိပါတယ် ခင်ဗျာ။
</Aside>
