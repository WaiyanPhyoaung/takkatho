...
<Aside title="ရည်ရွယ်ချက်" type="tip">
  `satisfies` ကို ဘယ်လိုနေရာတွေမှာ အသုံးဝင်သလဲ၊ အကောင်းဆုံး ဘယ်လိုသုံးလို့ရသလဲဆိုတာ
  လေ့လာကြည့်ရအောင်။
</Aside>

## Configuration Objects

Configuration ဆိုတာ Settings တွေ စုထားတဲ့ Object တွေပေါ့။ ဥပမာ - Website ရဲ့ Theme (အရောင်) တွေ၊ Fonts တွေ၊ Padding တွေ စသဖြင့်ပေါ့။ ဒီလို Settings တွေကို စီမံခန့်ခွဲတဲ့အခါ `satisfies` က အရမ်း အသုံးဝင်ပါတယ်။ ပုံစံမှန်အောင် ထိန်းပေးရုံတင်မကဘဲ၊ Setting တစ်ခုချင်းစီရဲ့ အသေးစိတ် အချက်အလက်တွေကိုပါ လုံလုံခြုံခြုံ ပြန်ထုတ်သုံးလို့ရအောင် ကူညီပေးပါတယ်။

<Code lang="typescript" code={configuration} title="config.ts" />

### `satisfies` ရဲ့ အကျိုးကျေးဇူးများ

၁။ စစ်ဆေးပေးခြင်း (Validation): `myAppTheme` Object ဟာ `AppTheme` ဆိုတဲ့ သတ်မှတ်ထားတဲ့ ပုံစံနဲ့ ကိုက်ညီရဲ့လားဆိုတာ `satisfies` က စစ်ဆေးပေးပါတယ်။

- `activeTheme` ကို `"blue"` လို့ ထားမိရင် Error တက်ပါမယ်။
- `button.padding` ကို Number မဟုတ်ဘဲ String (`"10px"`) ထည့်မိရင်လည်း Error တက်ပါမယ်။
- `button.extraProp` ဆိုပြီး မရှိတဲ့ Property ထပ်ထည့်မိရင်လည်း Error တက်ပါမယ်။
...
Objects တွေကို Key-Value Pairs တွေ စုထားတဲ့ Dictionary လိုမျိုး သုံးရတဲ့အခါမျိုးမှာ `satisfies` က အရမ်း အသုံးဝင်ပါတယ်။ Keys တွေ အကုန်ပါရဲ့လား၊ Values တွေက မှန်ရဲ့လားဆိုတာ သေချာအောင် လုပ်ပေးနိုင်သလို၊ ဒီ Object ကို တစ်ခုချင်း လိုက်စစ်တာတို့၊ `Record` တစ်ခုလို သုံးတာတို့လည်း လုပ်လို့ရပါတယ် ခင်ဗျာ။

<Code lang="typescript" code={dictionary} title="permission.ts" />

## Array/Tuple တစ်ခုမှာ ခွင့်ပြုထားတဲ့ Types တွေပဲ ပါကြောင်း သေချာစေခြင်း

အရောင်တွေကို စီစဉ်တဲ့ Palettes တွေ၊ ခိုင်းစေချက်တွေ ဆင့်ခေါ်တဲ့ Command Sequences တွေလိုမျိုး နေရာတွေမှာ သုံးလို့ ကောင်းပါတယ်။
