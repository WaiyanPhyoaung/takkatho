...
### လက်တွေ့အခြေအနေ - မလွယ်ပါဘူး

Microservices တွေက အစွမ်းထက်ပေမယ့်၊ သူတို့က သိသိသာသာ ရှုပ်ထွေးမှုတွေကို ဖြစ်ပေါ်စေပါတယ်။ ခင်ဗျားက Monolith ရဲ့ ပြဿနာတွေကို Distributed Systems တွေရဲ့ ပြဿနာအသစ်တွေနဲ့ လဲလှယ်လိုက်တာပါပဲ။

#### စိန်ခေါ်မှု 1: နေရာအနှံ့ရှိ Data များကို စီမံခန့်ခွဲခြင်း
...
#### စိန်ခေါ်မှု 2: လုပ်ငန်းလည်ပတ်မှုဆိုင်ရာ ရှုပ်ထွေးမှု (Operational Complexity)
...
- **Monitoring:** System တစ်ခုလုံး ကောင်းကောင်း အလုပ်လုပ်ရဲ့လားဆိုတာ ဘယ်လိုသိမလဲ။ User Request တစ်ခုက Service ၅ ခုလောက်ဆီကို "ခုန်ကူး" သွားနိုင်တယ်။ ပြဿနာဘယ်မှာဖြစ်လဲဆိုတာ အတိအကျသိဖို့ Distributed Tracing လိုမျိုး ရှုပ်ထွေးတဲ့ Tool တွေ လိုအပ်ပါတယ်။
- **Debugging:** Error တစ်ခုရဲ့ အရင်းအမြစ်ကို ရှာရတာ အများကြီးပိုခက်ပါတယ်။ ပြဿနာက Service ၃ ခုထဲက တစ်ခုခုမှာဖြစ်နိုင်သလို၊ သူတို့ကြားက Network ဆက်သွယ်မှုမှာလည်း ဖြစ်နိုင်ပါတယ်။

#### နံပါတ် 1 ထောင်ချောက် - The Distributed Monolith

- ဒါက အဆိုးဆုံးအခြေအနေပါ။ ဘာလဲဆိုတော့ Application ကို Service အသေးလေးတွေအဖြစ် ခွဲထုတ်လိုက်ပေမယ့်၊ သူတို့က တစ်ခုနဲ့တစ်ခု အရမ်းကို တင်းကျပ်စွာ ချိတ်ဆက် (Tightly Coupled) နေလို့၊ Service တစ်ခုမှာ အပြောင်းအလဲလုပ်လိုက်တာနဲ့ တခြား Service အများအပြားကိုပါ လိုက်ပြီးအတူတူ Deploy လုပ်နေရတာမျိုးပါ။
- ရလဒ်အနေနဲ့ Distributed System ရဲ့ အခက်အခဲတွေအားလုံးကို ရရှိပြီး၊ Monolith ရဲ့ အားသာချက်ရော၊ Microservices ရဲ့ အားသာချက်ပါ ဘာတစ်ခုမှ မရလိုက်ပါဘူး။
