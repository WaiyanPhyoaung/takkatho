...
<Aside title="ရည်ရွယ်ချက်">
  Microservices Architecture ရဲ့ အဓိကလက္ခဏာရပ်တွေကို နားလည်ပြီး၊ Service တွေကို ဘယ်လိုပုံစံဒီဇိုင်းဆွဲရမလဲဆိုတာကို ခင်ဗျားတို့ စဉ်းစားတတ်လာစေရန် ဖြစ်ပါတယ်။
</Aside>
