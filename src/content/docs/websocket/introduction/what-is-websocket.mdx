...
<ContentImage imgSrc={biDirectional} altText='websocket bi-directional connection' />
...
<ContentImage imgSrc={websocketConnection} altText='browser and server ws connection' />
