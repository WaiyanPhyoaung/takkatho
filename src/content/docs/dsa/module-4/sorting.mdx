...
Programming Languages တိုင်းမှာ `array.sort()` ဆိုပြီး ပါလာတတ်ပါတယ်။
ဒါတွေက နောက်ကွယ်မှာ အမြန်ဆုံး Algorithm (ဥပမာ Timsort - Python/Java, QuickSort - JS V8 Engine) တွေကို သုံးပေးထားတာပါ။
လက်တွေ့ဘဝမှာတော့ ကိုယ်တိုင် Bubble Sort ရေးနေစရာ မလိုပါဘူး။ Built-in Functions တွေကို ဘယ်အချိန် သုံးရမလဲ သိဖို့က ပိုအရေးကြီးပါတယ်။

<Aside title="Stability">
Sorting မှာ **Stable** ဖြစ်တယ်ဆိုတာ တန်ဖိုးတူတဲ့ Items တွေရဲ့ မူလရှေ့နောက် အစီအစဉ် မပျက်သွားတာကို ပြောတာပါ။ (ဥပမာ - နာမည်နဲ့ အရင်စီထားပြီးသား စာရင်းကို အသက်နဲ့ ထပ်စီတဲ့အခါ၊ အသက်တူရင် နာမည်အစီအစဉ် မပျက်သွားတာမျိုးပေါ့။) Merge Sort က Stable ဖြစ်ပြီး၊ Quick Sort က ပုံမှန်အားဖြင့် မဖြစ်ပါဘူး။
</Aside>

## Visual Guides

![Bubble Sort Pass-by-Pass](../../../../assets/dsa/bubble-sort-pass-by-pass.svg)
![Divide & Conquer Split/Merge Diagram](../../../../assets/dsa/divide-conquer-split-merge-diagram.svg)
![Runtime Comparison Chart](../../../../assets/dsa/runtime-comparison-chart.svg)
