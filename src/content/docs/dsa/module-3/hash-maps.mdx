...
![Hash Function Flow](../../../../assets/dsa/hash-function-flow.svg)

### Handling Collisions

မတူညီတဲ့ Keys နှစ်ခု (ဥပမာ "Apple" နဲ့ "Ava") ကို Hash လုပ်လိုက်တဲ့အခါ တိုက်ဆိုင်စွာနဲ့ နေရာတစ်ခုတည်း (Index တူတူ) သွားကျနေတာမျိုး ဖြစ်တတ်ပါတယ်။ ဒါကို **Collision** လို့ခေါ်တယ်။
...
![Collision Handling Visual](../../../../assets/dsa/collision-handling-visual.svg)
...
![Dictionary Lookup UI](../../../../assets/dsa/dictionary-lookup-ui.svg)
