...
DP ဆိုတာ နာမည်ကြီးလွန်းလို့ ကြောက်စရာ ကောင်းတယ်လို့ ထင်ရပေမဲ့၊ တကယ်တော့ **Recursion + Caching** ပါပဲ။
...
ဒါဆို ညာဘက်မှာ `+ 1` ထပ်ထည့်လိုက်ရင် ဘယ်လောက်လဲ?
(9)

ဥပမာလေးမှာ `1` ကနေ `8` အထိ ပြန်ပေါင်းစရာ မလိုပါဘူး။ "၈" လို့ သိထားပြီးသားမို့၊ `8 + 1 = 9` ဆိုပြီး ချက်ချင်း ဖြေနိုင်ပါတယ်။ ဒါ DP ပါပဲ။
...
![Overlapping Subproblems Tree](../../../../assets/dsa/overlapping-subproblems-tree.svg)
![Memoization Cache Table](../../../../assets/dsa/memoization-cache-table.svg)
![Bottom-up DP Grid](../../../../assets/dsa/bottom-up-dp-grid.svg)
