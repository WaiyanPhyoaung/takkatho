...
- **ထိရောက်မှုမရှိသော Event Handlers များ** - JavaScript ကုဒ်များ ရှုပ်ထွေးခြင်း (သို့) သေချာ Optimized လုပ်မထားခြင်းကြောင့် User ရဲ့တုံ့ပြန်မှုများကို နှေးစေပါသည်။
