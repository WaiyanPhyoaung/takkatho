...
<Aside title="ရည်ရွယ်ချက်">
  အလွန်မြန်ဆန်ပြီး၊ အပြန်အလှန်တုံ့ပြန်မှု(interactivity) ကောင်းမွန်သော website
  များကို တည်ဆောက်နိုင်သည့် ခေတ်မီ architectural patterns များ၏
  အခြေခံသဘောတရားကို နားလည်ရန်။
</Aside>
