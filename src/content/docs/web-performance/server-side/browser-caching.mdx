...
- **offline** အသုံးပြုနိုင်အောင် (user offline ဖြစ်နေရင်တောင် cache ထဲကဖိုင်တွေကို ပြန်ပေးခြင်း) ဒါမှမဟုတ် HTTP header တွေထက်ပိုရှုပ်ထွေးတဲ့ caching တွေ လုပ်နိုင်ပါတယ်။
