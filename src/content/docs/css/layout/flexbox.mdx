...
Flexbox ကို နားလည်ဖို့ အရေးအကြီးဆုံးက **ဝင်ရိုး (Axis) နှစ်ခု** ကို မြင်ထားဖို့ပါ။ နောက်ပိုင်း property တွေ (`justify-content`, `align-items`) က ဒီဝင်ရိုးတွေအပေါ် မူတည်ပါတယ်။

- **Main Axis (ပင်မ ဝင်ရိုး):** item တွေ စီတဲ့ ဦးတည်ချက်။ `flex-direction: row` ဆိုရင် **ဘေးတိုက် (→)**၊ `column` ဆိုရင် **ဒေါင်လိုက် (↓)**။
- **Cross Axis (ဖြတ်သန်း ဝင်ရိုး):** Main Axis ရဲ့ **ထောင့်မှန် (၉၀ ဒီဂရီ) ဘက်** ဝင်ရိုး။

<ContentImage src={flexAxes} alt="Flexbox Main Axis နဲ့ Cross Axis — row နဲ့ column ဖြစ်တဲ့အခါ ဝင်ရိုးများ ပြောင်းလဲပုံ" />

<Aside type="note">
`flex-direction` ကို ပြောင်းလိုက်တာနဲ့ Main Axis ရော Cross Axis ရော လိုက်ပြောင်းသွားပါတယ်။ ဒါကြောင့် `justify-content: center` က row မှာ **ဘေးတိုက် အလယ်**၊ column မှာ **ဒေါင်လိုက် အလယ်** ဖြစ်သွားတာပါ။
</Aside>
