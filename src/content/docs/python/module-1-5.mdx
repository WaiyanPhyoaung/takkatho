...
- String ကို ဖြတ်ညှပ်ခြင်း၊ ပြောင်းလဲခြင်း Methods တွေကို သုံးနိုင်မယ်
- String ကို Index နဲ့ Slicing ကို သုံးပြီး ဖြတ်ယူနိုင်မယ်
- f-strings ကို ကျွမ်းကျင်စွာ သုံးနိုင်မယ်
- User Input ကို မှန်ကန်အောင် စစ်ဆေးနိုင်မယ်
</Aside>

<Aside type="tip" title="ဒီ Module မစခင်">
Module 1 (Variables & Data Types) ကို ပြီးမှသာ ဆက်ကြည့်ပေးပါ။ String ဆိုတာ ဘာလဲ ဆိုတာ သေချာသိပြီးမှ Methods တွေကို လေ့လာစေချင်ပါတယ်။
</Aside>

String ဆိုတာကို Module 1 မှာ Data Type တစ်ခုအနေနဲ့ မိတ်ဆက်ပေးခဲ့ပြီးပါပြီ။ ဒီ Module မှာတော့ String တွေကို **တကယ်တမ်း အသုံးကျတဲ့ နည်းလမ်းတွေ** နဲ့ ကိုင်တွယ်တတ်အောင် သင်ပေးသွားပါမယ်။
...
f-string ဆိုတာ String ထဲမှာ Variable တွေ ကြည့်ကောင်းအောင် ထည့်ဖို့ Python 3.6 မှာ ထည့်သွင်းလာတဲ့ နည်းလမ်းပါ။ String ရှေ့မှာ `f` တစ်လုံး ထည့်ပြီး `{}` ထဲမှာ Variable ထည့်ပေးရုံပါပဲ။
...
# ဟောင်းနွမ်းသောနည်း (မသုံးသင့်ပါ)
...
String Methods တွေကို ပေါင်းစပ်ပြီး တကယ်တမ်း သုံးကြည့်ပါမယ်:
...
title = clean.title()              # "Aung Aung"  (အစစာလုံးအကြီး)
...
if not clean:
    ...
    print("Name က အတိုဆုံး ၂ လုံး ရှိရပါမယ်")
else:
...
အဆင့်ဆင့် အလုပ်လုပ်သွားပါတယ်: strip → lower → replace
</Aside>

<Aside title="နောက်တစ်ဆင့်">
String Methods ကို ကောင်းကောင်းသိပြီဆိုရင်တော့ **Module 2 — Control Flow** ကို ဆက်သွားနိုင်ပါပြီ!
</Aside>
