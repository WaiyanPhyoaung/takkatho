...
- List, Dict, Tuple, Set ကွာခြားချက်ကို ရှင်းလင်းစွာ နားလည်သွားမယ်
- `dict.get()` ကိုသုံးပြီး Safe Access လုပ်နိုင်မယ်
- Nested Data Structures (List of Dicts) ကိုင်တွယ်နိုင်မယ်
- Built-in Functions — sorted(), sum(), min(), max() သုံးနိုင်မယ်
- ဘယ် Data Structure ကို ဘယ်အချိန် ရွေးချယ်ရမလဲဆိုတာ ဆုံးဖြတ်နိုင်မယ်
</Aside>

<Aside type="tip" title="ဒီ Module မစခင်">
Module 1-3 ပြီးမှသာ ဆက်ကြည့်ပေးပါ။ Variables နဲ့ Loops ကို သိပြီးမှ Data Structures တွေကို ကောင်းကောင်း နားလည်နိုင်မှာပါ။
</Aside>
...
<Aside type="caution" title="KeyError ကို သတိထားပါ">
`student["phone"]` ဟာ "phone" Key မရှိရင် **KeyError** တက်ပါမယ်။ မသေချာတဲ့ Key တွေကို Access လုပ်ချိန်တိုင်း `.get()` ကို သုံးပေးပါ:
...
# ✅ Safe ဖြစ်တယ်
phone = student.get("phone", "N/A")   # "N/A"  ပြန်ပေးမယ်
```
</Aside>
...
|---|---|---|
| **List** | အစဉ်လိုက် ဖြစ်ရမယ်၊ ပြင်ရမယ်၊ ထပ်တဲ့တန်ဖိုး ပါနိုင်တယ် | မှာထားသော Items, ကျောင်းသားစာရင်း |
| **Dict** | Key-Value တွဲနဲ့ ရှာနိုင်ရမယ် | User Profile, Settings Config |
| **Tuple** | ပြောင်းလဲမှာ မဟုတ်တဲ့တန်ဖိုး | GPS Coordinates, RGB |
| **Set** | Unique တန်ဖိုးသာ၊ Duplicate မလိုဘူး | Login Sessions, Tag List |
...
Data Structures ကို ကောင်းကောင်းသိပြီဆိုရင်တော့ **Module 4.5 — Comprehensions** မှာ ဒီ Data Structures တွေကို Python Style နဲ့ ပိုမြန်ပိုတိုစွာ ကိုင်တွယ်နည်း ဆက်လက် သင်ကြားပေးသွားပါမယ်!
</Aside>
