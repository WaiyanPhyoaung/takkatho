...
<LinkCard
  title="CSS Course"
  description="Website တွေလှပဖို့ CSS ကို လေ့လာရန်"
...
HTML လေ့လာခြင်းက ဒီမှာပဲ မပြီးဆုံးသေးပါဘူး။ ခင်ဗျားရဲ့ skill တွေကို တိုးတက်အောင်လုပ်ဖို့နဲ့ စမ်းသပ်ဖို့အတွက် ဒီ site တွေကို အသုံးပြုနိုင်ပါတယ်:
...
အခုဆိုရင် ခင်ဗျား သင်ယူခဲ့သမျှ အားလုံးကို ပေါင်းစပ်ပြီး အောက်ပါ project လေးတွေ စလုပ်နိုင်ပါပြီ:
...
- Responsive design က ခင်ဗျားရဲ့ website ဟာ device အားလုံးမှာ အဆင်ပြေစေတယ်။
