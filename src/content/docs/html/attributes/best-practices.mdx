...
ဒီအခန်းမှာ သပ်ရပ်ပြီး လူတိုင်း အလွယ်တကူ အသုံးပြုနိုင်တဲ့ (Accessible ဖြစ်တဲ့) HTML code တွေ ရေးဖို့အတွက် လိုက်နာသင့်တဲ့ Best Practices (အကောင်းဆုံး လက်တွေ့အသုံးချနည်းများ) ကို လေ့လာကြပါမယ် ခင်ဗျာ။ ပြီးတော့ အဖြစ်များလေ့ရှိတဲ့ HTML အမှားတွေကိုလည်း တွဲပြီး လေ့လာသွားမှာပါ။
</Aside>
...
- **Attributes** တွေက HTML element တွေအတွက် အပို အချက်အလက်တွေ ပေးပြီး သူတို့ကို ထိန်းချုပ်နိုင်ပါတယ်။

- Accessibility နဲ့ SEO ပိုကောင်းစေဖို့ **Semantic HTML tag** တွေကို သေချာ ရွေးချယ်သုံးပါ။

- ပုံတွေအတွက် **`alt` text** ကို အမြဲ သုံးပြီး Link တွေကို **ရှင်းလင်းပြီး အဓိပ္ပာယ်ရှိအောင်** လုပ်ပေးပါ။

- ပြုပြင်ထိန်းသိမ်းရ လွယ်ကူစေဖို့ **Inline style တွေ ရှောင်ပြီး** CSS file ကိုသာ သုံးပါ ခင်ဗျာ။
</Aside>
