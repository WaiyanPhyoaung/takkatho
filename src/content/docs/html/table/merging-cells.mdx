...
ဒီအခန်းမှာတော့ table ထဲမှာ cell တွေကို `colspan` (အလျားလိုက်) နဲ့ `rowspan` (ဒေါင်လိုက်) သုံးပြီး ပေါင်းစပ်နည်းနဲ့ CSS နဲ့ table style ချနည်းကို လေ့လာကြပါမယ်။
</Aside>
...
- `<caption>` က ခင်ဗျားရဲ့ table ကို ခေါင်းစဉ်တပ်ပေးပါတယ်။
